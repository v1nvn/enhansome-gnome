# Awesome GNOME [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 469,488 | 🐛 76 | 📅 2026-05-05 with stars
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,356 | 🐛 30 | 🌐 Python | 📅 2026-05-22 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [AdwSteamGtk](https://flathub.org/apps/io.github.Foldex.AdwSteamGtk) - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,546 | 🐛 21 | 🌐 CSS | 📅 2026-05-13 skin installer.
* [Dynamic Gnome Wallpapers](https://github.com/manishprivet/dynamic-gnome-wallpapers) ⭐ 497 | 🐛 11 | 🌐 Shell | 📅 2024-11-01 - Gallery of MacOS like dynamic wallpapers, and easy scripts to install them
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 4,826 | 🐛 117 | 🌐 Rust | 📅 2026-05-22 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 1,028 | 🐛 78 | 🌐 Meson | 📅 2026-04-28 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 7,842 | 🐛 554 | 🌐 Shell | 📅 2026-04-02 - Material icon theme, initially based on Paper.

#### Flat Icons

* [La Capitaine](https://github.com/keeferrourke/la-capitaine-icon-theme) ⭐ 1,991 | 🐛 116 | 🌐 Shell | 📅 2021-11-25 - Icon inspired by macOS and Material Design guidelines.

#### Homogeneous Icons

* [Numix Circle](https://github.com/numixproject/numix-icon-theme-circle) ⭐ 931 | 🐛 3 | 📅 2026-02-21 - Flat rounded icon theme.
* [Obsidian](https://github.com/madmaxms/iconpack-obsidian) ⭐ 228 | 🐛 26 | 📅 2021-06-03 - Continuation of the famous Faenza theme.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,653 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
* [Capitaine Cursors](https://github.com/keeferrourke/capitaine-cursors) ⭐ 1,207 | 🐛 16 | 🌐 Python | 📅 2022-06-05 - An x-cursor theme inspired by macOS and based on KDE Breeze. Designed to be paired with La Capitaine icons.
* [ComixCursors](https://www.gnome-look.org/p/999996) - X11 mouse theme with a comics feeling.

### Themes for non-GTK apps

* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,870 | 🐛 38 | 🌐 CSS | 📅 2026-05-08 - Integrate Firefox into GNOME-based desktop using Adwaita.
* [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,546 | 🐛 21 | 🌐 CSS | 📅 2026-05-13 - Skin to make Steam look more like a native GNOME app.
...
* [Discord GNOME Theme](https://github.com/ricewind012/discord-gnome-theme) ⭐ 153 | 🐛 7 | 🌐 SCSS | 📅 2026-05-02 - A GNOME theme for Discord, following the Adwaita style & GNOME Human Interface Guidelines.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,226 | 🐛 6 | 🌐 Python | 📅 2026-05-20 - Collections of awesome native open-source GTK (4 and 3) applications.
