# Awesome GNOME [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 453,363 | 🐛 59 | 📅 2026-04-02 with stars
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,308 | 🐛 30 | 🌐 Python | 📅 2026-04-05 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 4,692 | 🐛 99 | 🌐 Rust | 📅 2026-04-08 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 987 | 🐛 70 | 🌐 Meson | 📅 2026-04-04 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 7,752 | 🐛 536 | 🌐 Shell | 📅 2026-04-02 - Material icon theme, initially based on Paper.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,477 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
...
* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,857 | 🐛 29 | 🌐 CSS | 📅 2026-04-07 - Integrate Firefox into GNOME-based desktop using Adwaita.
...
* [Discord GNOME Theme](https://github.com/ricewind012/discord-gnome-theme) ⭐ 141 | 🐛 7 | 🌐 SCSS | 📅 2026-04-03 - A GNOME theme for Discord, following the Adwaita style & GNOME Human Interface Guidelines.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,210 | 🐛 3 | 🌐 Python | 📅 2026-03-24 - Collections of awesome native open-source GTK (4 and 3) applications.
