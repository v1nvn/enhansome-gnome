# Awesome GNOME [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 469,154 | 🐛 76 | 📅 2026-05-05 with stars
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,354 | 🐛 30 | 🌐 Python | 📅 2026-05-22 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 4,823 | 🐛 117 | 🌐 Rust | 📅 2026-05-22 - Mouse and keyboard sharing software (software KVM switch).
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 7,841 | 🐛 555 | 🌐 Shell | 📅 2026-04-02 - Material icon theme, initially based on Paper.

#### Flat Icons

* [La Capitaine](https://github.com/keeferrourke/la-capitaine-icon-theme) ⭐ 1,989 | 🐛 116 | 🌐 Shell | 📅 2021-11-25 - Icon inspired by macOS and Material Design guidelines.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,652 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
...
* [Discord GNOME Theme](https://github.com/ricewind012/discord-gnome-theme) ⭐ 152 | 🐛 7 | 🌐 SCSS | 📅 2026-05-02 - A GNOME theme for Discord, following the Adwaita style & GNOME Human Interface Guidelines.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,225 | 🐛 6 | 🌐 Python | 📅 2026-05-20 - Collections of awesome native open-source GTK (4 and 3) applications.
