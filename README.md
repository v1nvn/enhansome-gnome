# Awesome GNOME [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 448,353 | 🐛 87 | 📅 2026-03-09 with stars
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,285 | 🐛 28 | 🌐 Python | 📅 2026-03-20 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [AdwSteamGtk](https://flathub.org/apps/io.github.Foldex.AdwSteamGtk) - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,526 | 🐛 20 | 🌐 CSS | 📅 2026-02-22 skin installer.
* [Dynamic Gnome Wallpapers](https://github.com/manishprivet/dynamic-gnome-wallpapers) ⭐ 488 | 🐛 11 | 🌐 Shell | 📅 2024-11-01 - Gallery of MacOS like dynamic wallpapers, and easy scripts to install them
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 4,643 | 🐛 92 | 🌐 Rust | 📅 2026-02-24 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 973 | 🐛 69 | 🌐 Meson | 📅 2026-02-17 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 7,722 | 🐛 532 | 🌐 Shell | 📅 2026-03-16 - Material icon theme, initially based on Paper.
...
* [Numix Circle](https://github.com/numixproject/numix-icon-theme-circle) ⭐ 927 | 🐛 3 | 📅 2026-02-21 - Flat rounded icon theme.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,328 | 🐛 16 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
* [Capitaine Cursors](https://github.com/keeferrourke/capitaine-cursors) ⭐ 1,186 | 🐛 16 | 🌐 Python | 📅 2022-06-05 - An x-cursor theme inspired by macOS and based on KDE Breeze. Designed to be paired with La Capitaine icons.
* [ComixCursors](https://www.gnome-look.org/p/999996) - X11 mouse theme with a comics feeling.

### Themes for non-GTK apps

* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,854 | 🐛 41 | 🌐 CSS | 📅 2026-03-09 - Integrate Firefox into GNOME-based desktop using Adwaita.
* [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,526 | 🐛 20 | 🌐 CSS | 📅 2026-02-22 - Skin to make Steam look more like a native GNOME app.
* [Thunderbird GNOME Theme](https://github.com/rafaelmardojai/thunderbird-gnome-theme) ⭐ 392 | 🐛 8 | 🌐 CSS | 📅 2026-03-09 - Integrate Thunderbird into GNOME-based desktop using Adwaita.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,202 | 🐛 3 | 🌐 Python | 📅 2026-03-23 - Collections of awesome native open-source GTK (4 and 3) applications.
