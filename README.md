# Awesome GNOME [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,983 | 🐛 70 | 📅 2026-01-28 with stars
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,238 | 🐛 34 | 🌐 Python | 📅 2026-02-06 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [AdwSteamGtk](https://flathub.org/apps/io.github.Foldex.AdwSteamGtk) - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,507 | 🐛 20 | 🌐 CSS | 📅 2026-02-01 skin installer.
...
* [Luminance](https://github.com/sidevesh/Luminance) ⭐ 144 | 🐛 6 | 🌐 C | 📅 2026-02-16 - Simple application to control brightness of displays (including external) supporting DDC/CI.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 4,545 | 🐛 92 | 🌐 Rust | 📅 2026-02-20 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 947 | 🐛 65 | 🌐 Meson | 📅 2026-02-17 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 7,651 | 🐛 526 | 🌐 Shell | 📅 2026-02-21 - Material icon theme, initially based on Paper.
...
* [Numix Circle](https://github.com/numixproject/numix-icon-theme-circle) ⭐ 926 | 🐛 3 | 📅 2026-02-11 - Flat rounded icon theme.
...
* [Elementary XFCE](https://github.com/shimmerproject/elementary-xfce) ⭐ 289 | 🐛 27 | 🌐 C | 📅 2026-01-02 - Desktop-agnostic version of the icons of elementary OS.

### Cursors

* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,205 | 🐛 16 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
* [Capitaine Cursors](https://github.com/keeferrourke/capitaine-cursors) ⭐ 1,178 | 🐛 16 | 🌐 Python | 📅 2022-06-05 - An x-cursor theme inspired by macOS and based on KDE Breeze. Designed to be paired with La Capitaine icons.
* [ComixCursors](https://www.gnome-look.org/p/999996) - X11 mouse theme with a comics feeling.

### Themes for non-GTK apps

* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,840 | 🐛 36 | 🌐 CSS | 📅 2026-02-16 - Integrate Firefox into GNOME-based desktop using Adwaita.
* [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,507 | 🐛 20 | 🌐 CSS | 📅 2026-02-01 - Skin to make Steam look more like a native GNOME app.
* [Thunderbird GNOME Theme](https://github.com/rafaelmardojai/thunderbird-gnome-theme) ⭐ 377 | 🐛 10 | 🌐 CSS | 📅 2025-09-07 - Integrate Thunderbird into GNOME-based desktop using Adwaita.
...
* [Discord GNOME Theme](https://github.com/ricewind012/discord-gnome-theme) ⭐ 136 | 🐛 9 | 🌐 SCSS | 📅 2026-01-25 - A GNOME theme for Discord, following the Adwaita style & GNOME Human Interface Guidelines.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,181 | 🐛 2 | 🌐 Python | 📅 2026-02-13 - Collections of awesome native open-source GTK (4 and 3) applications.
