# Awesome GNOME [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 449,693 | 🐛 88 | 📅 2026-03-09 with stars
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,293 | 🐛 28 | 🌐 Python | 📅 2026-03-20 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 4,654 | 🐛 95 | 🌐 Rust | 📅 2026-03-26 - Mouse and keyboard sharing software (software KVM switch).
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,379 | 🐛 17 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
...
* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,856 | 🐛 43 | 🌐 CSS | 📅 2026-03-09 - Integrate Firefox into GNOME-based desktop using Adwaita.
