# Awesome GNOME [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 452,662 | 🐛 60 | 📅 2026-04-02 with stars
...
* [Netsleuth](https://github.com/vmkspv/netsleuth) ⭐ 50 | 🐛 1 | 🌐 Python | 📅 2026-04-05 - Utility for the calculation and analysis of IP subnet values.
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,303 | 🐛 28 | 🌐 Python | 📅 2026-04-05 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 4,684 | 🐛 99 | 🌐 Rust | 📅 2026-03-26 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 985 | 🐛 70 | 🌐 Meson | 📅 2026-04-04 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 7,747 | 🐛 534 | 🌐 Shell | 📅 2026-04-02 - Material icon theme, initially based on Paper.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,450 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
...
* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,854 | 🐛 28 | 🌐 CSS | 📅 2026-04-06 - Integrate Firefox into GNOME-based desktop using Adwaita.
...
* [Discord GNOME Theme](https://github.com/ricewind012/discord-gnome-theme) ⭐ 139 | 🐛 8 | 🌐 SCSS | 📅 2026-04-03 - A GNOME theme for Discord, following the Adwaita style & GNOME Human Interface Guidelines.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,208 | 🐛 3 | 🌐 Python | 📅 2026-03-24 - Collections of awesome native open-source GTK (4 and 3) applications.
