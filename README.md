...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,364 | 🐛 31 | 🌐 Python | 📅 2026-05-22 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,869 | 🐛 39 | 🌐 CSS | 📅 2026-05-25 - Integrate Firefox into GNOME-based desktop using Adwaita.
