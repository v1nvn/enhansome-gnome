# Awesome GNOME [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 460,726 | 🐛 68 | 📅 2026-04-19 with stars
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,329 | 🐛 28 | 🌐 Python | 📅 2026-04-28 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 4,762 | 🐛 99 | 🌐 Rust | 📅 2026-04-29 - Mouse and keyboard sharing software (software KVM switch).
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 7,792 | 🐛 549 | 🌐 Shell | 📅 2026-04-02 - Material icon theme, initially based on Paper.
...
* [Thunderbird GNOME Theme](https://github.com/rafaelmardojai/thunderbird-gnome-theme) ⭐ 413 | 🐛 8 | 🌐 CSS | 📅 2026-04-03 - Integrate Thunderbird into GNOME-based desktop using Adwaita.
