# Awesome GNOME [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 460,013 | 🐛 67 | 📅 2026-04-19 with stars
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,325 | 🐛 28 | 🌐 Python | 📅 2026-04-28 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [AdwSteamGtk](https://flathub.org/apps/io.github.Foldex.AdwSteamGtk) - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,541 | 🐛 20 | 🌐 CSS | 📅 2026-02-22 skin installer.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 4,757 | 🐛 99 | 🌐 Rust | 📅 2026-04-09 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 1,006 | 🐛 75 | 🌐 Meson | 📅 2026-04-28 - An Adwaita-style icon theme for Gnome Shell.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 7,789 | 🐛 548 | 🌐 Shell | 📅 2026-04-02 - Material icon theme, initially based on Paper.

#### Flat Icons

* [La Capitaine](https://github.com/keeferrourke/la-capitaine-icon-theme) ⭐ 1,986 | 🐛 116 | 🌐 Shell | 📅 2021-11-25 - Icon inspired by macOS and Material Design guidelines.
...
* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,579 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
...
* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,862 | 🐛 32 | 🌐 CSS | 📅 2026-04-14 - Integrate Firefox into GNOME-based desktop using Adwaita.
* [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,541 | 🐛 20 | 🌐 CSS | 📅 2026-02-22 - Skin to make Steam look more like a native GNOME app.
