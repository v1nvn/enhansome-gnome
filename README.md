# Awesome GNOME [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 451,629 | 🐛 59 | 📅 2026-04-02 with stars
...
* [Netsleuth](https://github.com/vmkspv/netsleuth) ⭐ 50 | 🐛 1 | 🌐 Python | 📅 2026-04-03 - Utility for the calculation and analysis of IP subnet values.
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,303 | 🐛 28 | 🌐 Python | 📅 2026-03-30 - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
* [AdwSteamGtk](https://flathub.org/apps/io.github.Foldex.AdwSteamGtk) - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,531 | 🐛 20 | 🌐 CSS | 📅 2026-02-22 skin installer.
...
* [Luminance](https://github.com/sidevesh/Luminance) ⭐ 161 | 🐛 3 | 🌐 C | 📅 2026-04-03 - Simple application to control brightness of displays (including external) supporting DDC/CI.
...
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 4,673 | 🐛 98 | 🌐 Rust | 📅 2026-03-26 - Mouse and keyboard sharing software (software KVM switch).
...
* [MoreWaita](https://github.com/somepaulo/MoreWaita) ⭐ 979 | 🐛 70 | 🌐 Meson | 📅 2026-02-17 - An Adwaita-style icon theme for Gnome Shell.
* [Pop!](https://github.com/pop-os/icon-theme) ⭐ 214 | 🐛 15 | 🌐 Python | 📅 2024-10-01 - Official icon theme of Pop!\_OS by System76.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 7,744 | 🐛 534 | 🌐 Shell | 📅 2026-04-02 - Material icon theme, initially based on Paper.
...
* [Numix Circle](https://github.com/numixproject/numix-icon-theme-circle) ⭐ 928 | 🐛 3 | 📅 2026-02-21 - Flat rounded icon theme.
...
* [Elementary XFCE](https://github.com/shimmerproject/elementary-xfce) ⭐ 294 | 🐛 27 | 🌐 C | 📅 2026-01-02 - Desktop-agnostic version of the icons of elementary OS.

### Cursors

* [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) ⭐ 3,427 | 🐛 18 | 🌐 Shell | 📅 2024-06-18 - Silm material-based cursor theme.
* [Capitaine Cursors](https://github.com/keeferrourke/capitaine-cursors) ⭐ 1,191 | 🐛 16 | 🌐 Python | 📅 2022-06-05 - An x-cursor theme inspired by macOS and based on KDE Breeze. Designed to be paired with La Capitaine icons.
* [ComixCursors](https://www.gnome-look.org/p/999996) - X11 mouse theme with a comics feeling.

### Themes for non-GTK apps

* [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,850 | 🐛 30 | 🌐 CSS | 📅 2026-04-03 - Integrate Firefox into GNOME-based desktop using Adwaita.
* [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,531 | 🐛 20 | 🌐 CSS | 📅 2026-02-22 - Skin to make Steam look more like a native GNOME app.
* [Thunderbird GNOME Theme](https://github.com/rafaelmardojai/thunderbird-gnome-theme) ⭐ 391 | 🐛 6 | 🌐 CSS | 📅 2026-04-03 - Integrate Thunderbird into GNOME-based desktop using Adwaita.
...
* [Obsidian Adwaita Theme](https://github.com/birneee/obsidian-adwaita-theme) ⭐ 156 | 🐛 13 | 🌐 CSS | 📅 2025-09-25 - [Obsidian](https://obsidian.md) theme in the style of GNOME Adwaita.
* [Discord GNOME Theme](https://github.com/ricewind012/discord-gnome-theme) ⭐ 138 | 🐛 8 | 🌐 SCSS | 📅 2026-04-03 - A GNOME theme for Discord, following the Adwaita style & GNOME Human Interface Guidelines.
...
* [Awesome-GTK](https://github.com/valpackett/awesome-gtk) ⭐ 1,206 | 🐛 3 | 🌐 Python | 📅 2026-03-24 - Collections of awesome native open-source GTK (4 and 3) applications.
